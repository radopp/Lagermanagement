sap.ui.define(
    ...
    function (Controller, History, JSONModel, Fragment, Log, MessageBox) {
      ...
      return Controller.extend("at.clouddna.lagermanagement.controller.LieferantDetail", {
        _fragmentList: {},
        bCreate: false,
        ...
        _onPatternMatchedCreate: function (oEvent) {
          ...
          let oContext =this.getView().getModel().bindList("/Lieferanten").create(undefined, undefined, undefined, true);
        ...
        _toggleEdit: function (bEditMode) {
          ...
          this._showCustomerFragment(bEditMode ? "LieferantBearbeiten" : "LieferantDetails");
        },
         ...
         onSavePressed: function () {
          ...
          if(this.bCreate){
            ...
            let oListBinding=oModel.bindList("/Lieferanten");
            oListBinding.attachCreateCompleted((oEvent)=>{
              debugger;
            })
            oListBindingContext=this.getView().getModel().bindList("/Lieferanten").create(this.getView().getModel("createModel").getData());
