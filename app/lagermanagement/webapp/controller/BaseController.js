    ...
    return Controller.extend(
      "at.clouddna.lagermanagement.controller.BaseController",
      {
        ...
        deleteODataEntry: function (
          ...
          if (oParameters) {
            sTitle = oParameters.hasOwnProperty("dialogTitle")
              ? oParameters.dialogTitle
              : sTitle;
            sText = oParameters.hasOwnProperty("dialogText")
              ? oParameters.dialogText
              : sText;
            oUrlParameters = oParameters.hasOwnProperty("urlParameters")
